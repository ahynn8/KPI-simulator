...
가상 캠페인 기획서(로벡틴·SLONNE)의 KPI 수치가 실제로 손익분기를 달성하는지 검증하기 위해 직접 구현했습니다.
...
|---|---|---|---|---|---|
| 로벡틴 시카케어 밸런싱 토너 | 900만원 | 3.9% | 2.5% | 200.2% | 200% 달성 ✅ |
| SLONNE 롱핏 패션 | 300만원 | 2.6% | 2.0% | 271% | 250% 초과 달성 ✅ |
...
- 로벡틴 가상 캠페인 기획서 — Meta Ads 퍼포먼스 KPI 시뮬레이션 슬라이드 포함
- SLONNE 가상 캠페인 기획서 — Meta Ads 퍼포먼스 KPI 시뮬레이션 슬라이드 포함
